...
class ResNet(nn.Module):
    ...
    #     self.avg_pool = F.avg_pool2d(out, 4)
    #     self.Flatten = nn.Flatten()
    #     return {self.conv1, self.bn1, self.activation, self.layer1, self.layer2, self.layer3, 
    #             self.layer4, self.layer5, self.layer6, self.layer7, self.avg_pool, self.Flatten, self.linear}
...
def ISIC_ResNet18(num_classes):
    return ResNet(BasicBlock, [1, 1, 1, 1], num_classes=num_classes)
    # return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes)


def ISIC_ResNet34(num_classes):
    return ResNet(BasicBlock, [3, 4, 6, 3], num_classes=num_classes)


def ISIC_ResNet50(num_classes):
